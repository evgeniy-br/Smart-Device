...
document.querySelectorAll('.accordeon').forEach(function (accordeon) {
  accordeon.addEventListener('click', function () {
    var accordeonParent = accordeon.parentNode;
...
var interectiveElements = document.querySelectorAll('a, textarea, input, button, [tabindex]');
var interectiveElementsList = [];
...
if (modalCall) {
  orderButton.addEventListener('click', function (evt) {
    ...
    nameInput.focus();
    interectiveElements.forEach(function (interectiveElement) {
  ...
  modalCall.addEventListener('click', function (evt) {
    ...
    if (!target.closest('.modal-call__container')) {
